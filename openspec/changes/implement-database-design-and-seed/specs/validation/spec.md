...
The system SHALL validate numeric fields as positive integers, SHALL validate email and phone formats before insertion, and SHALL validate campaign_type to be one of 'Privat' or 'Næring'. These validations MAY be enforced at DB CHECKs and MUST be enforced at the application layer.
